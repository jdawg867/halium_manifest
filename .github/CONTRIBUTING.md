...
Open a Pull Request on GitHub → target branch dev/android-15.
...
Thanks for contributing to the Halium project!
...
```bash
mkdir -p .github
nano .github/CONTRIBUTING.md
# paste the file above, save and exit
git add .github/CONTRIBUTING.md
git commit -m "Add full contributing guide and branch workflow"
git push
